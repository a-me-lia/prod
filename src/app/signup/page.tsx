    ...
    <div className="flex flex-col items-center z-50">
        ...
        <label className='relative' htmlFor="mail">
                ...
                <div className="absolute bg-white p-[0.5]  text-slate-500 text-[10px] translate-x-2 -translate-y-2">Password</div>
                    <input className='border-2 py-1 px-2 min-w-[256px] rounded-lg'onChange={(e) => setPassword(e.target.value)} required type="password" name="password" id="password" placeholder="Password (min. 6 chars)" />
                </label>
                <label className='relative' htmlFor="confirmPassword">
                <div className="absolute bg-white p-[0.5]  text-slate-500 text-[10px] translate-x-2 -translate-y-2">Confirm Password</div>
                    <input className='border-2 py-1 px-2 min-w-[256px] rounded-lg'onChange={(e) => setConfirmPassword(e.target.value)} required type="password" name="confirmPassword" id="confirmPassword" placeholder="Confirm Password" />
                </label>
...
<div  className='w-48'></div>
            ...
            <button  className="w-[256px] mt-[-4px] text-right text-[14px]" onClick={goToSignIn}><p>Back to sign in</p></button>
