...
export default function Page() {
    ...
    return (
    <div className="  h-[calc(100dvh)] flex flex-col items-center bg-white  text-black overflow-hidden">
        <Link className='absolute left-2 top-2 border-2 border-opacity-30 rounded-lg border-black px-2 py-1'href='/'>Back to sign-in</Link>
        <Link className='absolute right-2 top-2 border-2 border-opacity-30 rounded-lg border-black px-2 py-1'href='/names'>Go to name view</Link>
